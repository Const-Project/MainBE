...
public class RealQuizController {
  ...
  public ApiResponse<RealQuizResponseDTO> createRealQuiz(
      @RequestBody RealQuizCreateRequestDTO requestDTO) {
  ...
  public ApiResponse<UserQuizCreateResponseDTO> createUserQuiz(
      @RequestBody UserQuizCreateRequestDTO requestDTO) {
    UserQuizCreateResponseDTO responseDTO =
        realQuizService.createUserQuiz(requestDTO.getUserId(), requestDTO.getQuizId());
    return ApiResponse.success(responseDTO);
  }
