...
//
// import
// com.example.cp_main_be.domain.mission.daily_mission_master.domain.repository.DailyMissionMasterRepository;
// import
// com.example.cp_main_be.domain.mission.daily_mission_master.dto.response.DailyMissionResponseDTO;
// import
// com.example.cp_main_be.domain.mission.user_daily_mission.domain.repository.UserDailyMissionRepository;
...
//  //        DailyMissionMaster.builder().id(1L).title("걷기 30분").description("공원에서 30분 이상
//  // 걷기").build();
//  //
...
//  //    DailyMissionResponseDTO.MissionSummaryDTO firstMission =
//  // responseDTO.getTodayMissions().get(0);
...
//  //
//  //    DailyMissionResponseDTO.MissionSummaryDTO secondMission =
//  // responseDTO.getTodayMissions().get(1);
