...
class AdminServiceTest {
    ...
    @Mock
    private DailyKeywordsRepository dailyKeywordsRepository;
    ...
    void createDailyMissionMasters_Success() {
        // Given
        AdminRequestDTO.CreateMissionRequestDTO requestDTO = AdminRequestDTO.CreateMissionRequestDTO.builder()
                .title("새 미션")
                .description("미션 설명")
                .content("미션 내용")
    ...
    void updateDailyMissionMasters_Success() {
        // Given
        Long missionId = 1L;
        AdminRequestDTO.UpdateMissionRequestDTO requestDTO = AdminRequestDTO.UpdateMissionRequestDTO.builder().build();
        requestDTO.setTitle("수정된 미션 제목");

        DailyMissionMasters existingMission = DailyMissionMasters.builder().id(missionId).title("원본 제목").build();
        given(dailyMissionMastersRepository.findById(missionId)).willReturn(Optional.of(existingMission));
    ...
    void createDailyKeywords_Success() {
        // Given
        AdminRequestDTO.CreateKeywordRequestDTO requestDTO = AdminRequestDTO.CreateKeywordRequestDTO.builder().build();
    ...
    void changeUserStatus_Success() {
        // Given
        Long userId = 1L;
        AdminRequestDTO.ChangeUserStatusRequestDTO requestDTO = AdminRequestDTO.ChangeUserStatusRequestDTO.builder().build();
    ...
    void createQuizOption_Success() {
        ...
        AdminRequestDTO.CreateQuizRequestDTO requestDTO = AdminRequestDTO.CreateQuizRequestDTO.builder()
        ...
        given(dailyMissionMastersRepository.findById(missionMasterId)).willReturn(Optional.of(missionMaster));
    ...
    void createNewPlant_Success() {
        // Given
        AdminRequestDTO.CreatePlantMasterRequestDTO requestDTO = AdminRequestDTO.CreatePlantMasterRequestDTO.builder()
                .plantName("새 식물")
                .plantType("허브")
                .build();
    ...
    void updatePlantMasters_Success() {
        // Given
        Long plantId = 1L;
        AdminRequestDTO.UpdatePlantMasterRequestDTO requestDTO = AdminRequestDTO.UpdatePlantMasterRequestDTO.builder().build();
